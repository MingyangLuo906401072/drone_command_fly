...
struct InstructionEntry {
	...
	// For some reason GCC on Linux (used with autograder), does not seem to treat this
	// as an aggregate class, and so doesn't make this automatically... might be my GCC,
	// but better safe than sorry I guess.
	InstructionEntry() = default;
	InstructionEntry(Opcodes opcode, int op1, int op2, bool const_op2)
		: opcode(opcode), operand1(op1), operand2(op2), constant_operand2(const_op2) {}
};
